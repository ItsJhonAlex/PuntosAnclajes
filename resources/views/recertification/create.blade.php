                        ...
                        <div class="row">
                            <div class="col-12">
                                <form method="POST" action="{{ route('recertification.store') }}">
                                            ...
                                            @if ($sistemaProteccion != 'undefined')
                                                @foreach ($sistemaProteccion as $sistema)
                                                    <option value="{{ $sistema->id }}">
                                                        {{ $sistema->nombre }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    {{--
                                    @foreach($dataRanges as $rangeTmp)
                                        <div class="mb-3 ">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Listado de precintos <div class="badge badge-pill badge-outline-primary" id="precintosLabelCounter">{{$cantPrecintos}}</div></h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <ul class="precintosULlist flex-container" id="precintosPairList">
                                                        ...
                                                        @foreach($dataRanges as $rangeTmp)
                                                            @php $indice++; @endphp
                                                        <li id="fila-{{$indice}}" data-idtemp="{{$indice}}">
                                                            <article class="card card-x mb-3 rounded-xl anclajeClosed">
                                                                <div class="card-body">
                                                                    <div class="card-headerCustom card-headerTMP">
                                                                        <h6 class="card-title">
                                                                            Rango de Precinto #<span class="spanCounterLabel">{{$indice}}</span>
                                                                            <span class="rangeVisualData badge badge--success" style="margin-left: 10px!important;">{{ $rangeTmp[0]->precinto.' - '. $rangeTmp[count($rangeTmp)-1]->precinto }}</span>
                                                                            <div class="anclajeButtons">
                                                                                <svg width="20px" height="20px" class="editPercint d-none" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M21.2799 6.40005L11.7399 15.94C10.7899 16.89 7.96987 17.33 7.33987 16.7C6.70987 16.07 7.13987 13.25 8.08987 12.3L17.6399 2.75002C17.8754 2.49308 18.1605 2.28654 18.4781 2.14284C18.7956 1.99914 19.139 1.92124 19.4875 1.9139C19.8359 1.90657 20.1823 1.96991 20.5056 2.10012C20.8289 2.23033 21.1225 2.42473 21.3686 2.67153C21.6147 2.91833 21.8083 3.21243 21.9376 3.53609C22.0669 3.85976 22.1294 4.20626 22.1211 4.55471C22.1128 4.90316 22.0339 5.24635 21.8894 5.5635C21.7448 5.88065 21.5375 6.16524 21.2799 6.40005V6.40005Z" stroke="#c0bfbc" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M11 4H6C4.93913 4 3.92178 4.42142 3.17163 5.17157C2.42149 5.92172 2 6.93913 2 8V18C2 19.0609 2.42149 20.0783 3.17163 20.8284C3.92178 21.5786 4.93913 22 6 22H17C19.21 22 20 20.2 20 18V13" stroke="#c0bfbc" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                                                                <svg width="20px" height="20px" class="editPercintActive"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M21.2799 6.40005L11.7399 15.94C10.7899 16.89 7.96987 17.33 7.33987 16.7C6.70987 16.07 7.13987 13.25 8.08987 12.3L17.6399 2.75002C17.8754 2.49308 18.1605 2.28654 18.4781 2.14284C18.7956 1.99914 19.139 1.92124 19.4875 1.9139C19.8359 1.90657 20.1823 1.96991 20.5056 2.10012C20.8289 2.23033 21.1225 2.42473 21.3686 2.67153C21.6147 2.91833 21.8083 3.21243 21.9376 3.53609C22.0669 3.85976 22.1294 4.20626 22.1211 4.55471C22.1128 4.90316 22.0339 5.24635 21.8894 5.5635C21.7448 5.88065 21.5375 6.16524 21.2799 6.40005V6.40005Z" stroke="#d97706" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M11 4H6C4.93913 4 3.92178 4.42142 3.17163 5.17157C2.42149 5.92172 2 6.93913 2 8V18C2 19.0609 2.42149 20.0783 3.17163 20.8284C3.92178 21.5786 4.93913 22 6 22H17C19.21 22 20 20.2 20 18V13" stroke="#d97706" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>

                                                                                <svg width="20px" height="20px" wire:loading.remove.delay.default="1" wire:target="mountFormComponentAction('data.items', 'delete', JSON.parse('{\u0022item\u0022:\u0022record-5\u0022}'))" class="fi-icon-btn-icon h-5 w-5 deletePrecintPair removePairActive" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#c0bfbc" aria-hidden="true" data-slot="icon">
                                                                    ...
                                                                    <div class="card-text pt-4 card-bodyTMP d-none">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-6 mb-3 ">
                                                                                ...
                                                                                <input type="number" class="form-control inputPrecintoInicial inputPrecintoRange" id="precinto_inicial" aria-describedby="" name="precinto_inicial[]" value="{{ $rangeTmp[0]->precinto}}" required>
                                                                            </div>
                                                                            <div class="col-6 mb-3 ">
                                                                                <label for="exampleInputPassword1" class="form-label">Número precinto final</label>
                                                                                <input type="number" class="form-control inputPrecintoFinal inputPrecintoRange" id="precinto_final" aria-describedby="" name="precinto_final[]" value="{{ $rangeTmp[count($rangeTmp)-1]->precinto }}" required>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <label for="exampleInputPassword1" class="form-label">Ubicación</label>
                                                                                <input type="text" class="form-control inputPrecintoUbicacion" id="ubicacion" aria-describedby="" name="ubicacion[]" required onkeyup="this.value = this.value.toUpperCase();" value="{{$rangeTmp[0]->ubicacion}}">
                                                                            </div>
                                                                        </div>
                                                                        </p>
                                                                    </div>
                                            ...
                                            <div class="row align-content-center d-none">
                                            ...
                                            @if ($usos != 'undefined')
                                                @foreach ($usos as $sistemaUso)
                                                    <option value="{{ $sistemaUso->uso_sistema_proteccion }}">
                                                        {{ $sistemaUso->uso_sistema_proteccion }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
